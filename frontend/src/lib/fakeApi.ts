...
export type WorkOrder = {
  ...
  repairShop?: string;
  status: "waiting_for_inspection" | "in_progress" | "follow-up_required" | "completed";
  dateReceived: string;
  dateUpdated: string;
};
...
// --- Mock Data --- //
const users: User[] = [
  { id: 1, name: "Alice Johnson", email: "alice@example.com", role: "Admin", status: "active", repairShop: "001", avatar: "https://i.pravatar.cc/40?img=1" },
  { id: 2, name: "Bob Smith", email: "bob@example.com", role: "User", status: "inactive", repairShop: "002", avatar: "https://i.pravatar.cc/40?img=2" },
  { id: 3, name: "Charlie Brown", email: "charlie@example.com", role: "Bodyman", status: "inactive", repairShop: "003", avatar: "https://i.pravatar.cc/40?img=3" },
  { id: 4, name: "Dana White", email: "dana@example.com", role: "Bodyman", status: "active", repairShop: "004", avatar: "https://i.pravatar.cc/40?img=4" },
  { id: 5, name: "Eve Adams", email: "eve@example.com", role: "Adjustor", status: "active", repairShop: "005", avatar: "https://i.pravatar.cc/40?img=5" },
  { id: 6, name: "Frank Moore", email: "frank@example.com", role: "User", status: "inactive", repairShop: "006", avatar: "https://i.pravatar.cc/40?img=6" },
  { id: 7, name: "Grace Lee", email: "grace@example.com", role: "Adjustor", status: "active", repairShop: "007", avatar: "https://i.pravatar.cc/40?img=7" },
  { id: 8, name: "Hank Miller", email: "hank@example.com", role: "User", status: "active", repairShop: "008", avatar: "https://i.pravatar.cc/40?img=8" },
  { id: 9, name: "Ivy Wilson", email: "ivy@example.com", role: "User", status: "inactive", repairShop: "009", avatar: "https://i.pravatar.cc/40?img=9" },
  { id: 10, name: "Jack Taylor", email: "jack@example.com", role: "Admin", status: "inactive", repairShop: "010", avatar: "https://i.pravatar.cc/40?img=10" },
  { id: 11, name: "Karen Thomas", email: "karen@example.com", role: "Manager", status: "active", repairShop: "011", avatar: "https://i.pravatar.cc/40?img=11" },
  { id: 12, name: "Liam Scott", email: "liam@example.com", role: "User", status: "inactive", repairShop: "012", avatar: "https://i.pravatar.cc/40?img=12" },
  { id: 13, name: "Mia Harris", email: "mia@example.com", role: "Bodyman", status: "active", repairShop: "013", avatar: "https://i.pravatar.cc/40?img=13" },
  { id: 14, name: "Noah Brooks", email: "noah@example.com", role: "Adjustor", status: "inactive", repairShop: "014", avatar: "https://i.pravatar.cc/40?img=14" },
  { id: 15, name: "Olivia Davis", email: "olivia@example.com", role: "User", status: "active", repairShop: "015", avatar: "https://i.pravatar.cc/40?img=15" },
  { id: 16, name: "Paul Wright", email: "paul@example.com", role: "Admin", status: "inactive", repairShop: "016", avatar: "https://i.pravatar.cc/40?img=16" },
  { id: 17, name: "Quinn Foster", email: "quinn@example.com", role: "Bodyman", status: "active", repairShop: "017", avatar: "https://i.pravatar.cc/40?img=17" },
  { id: 18, name: "Rachel Green", email: "rachel@example.com", role: "User", status: "inactive", repairShop: "018", avatar: "https://i.pravatar.cc/40?img=18" },
  { id: 19, name: "Sam Parker", email: "sam@example.com", role: "Adjustor", status: "active", repairShop: "019", avatar: "https://i.pravatar.cc/40?img=19" },
  { id: 20, name: "Tina Lopez", email: "tina@example.com", role: "User", status: "inactive", repairShop: "020", avatar: "https://i.pravatar.cc/40?img=20" },
];
...
const workOrders: WorkOrder[] = [
  ...
  { id: "Wo-004", customer: "Dana White", email: "dana@example.com", status: "follow-up_required", dateReceived: "3 October 2025", dateUpdated: "15 September 2025", customerAvatar: "https://i.pravatar.cc/40?img=4", phone: "456-789-0123", address: "456 Pine St, Anycity, USA", plate: "JKL012", make: "Chevrolet", model: "Malibu", dents: [] },
  ...
  { id: "Wo-006", customer: "Frank Moore", email: "frank@example.com", status: "follow-up_required", dateReceived: "12 September 2025", dateUpdated: "13 September 2025", customerAvatar: "https://i.pravatar.cc/40?img=6", phone: "678-901-2345", address: "678 Cedar St, Anyplace, USA", plate: "PQR678", make: "Hyundai", model: "Elantra", dents: [] },
  ...
  { id: "Wo-012", customer: "Liam Scott", email: "liam@example.com", status: "follow-up_required", dateReceived: "6 September 2025", dateUpdated: "7 September 2025", customerAvatar: "https://i.pravatar.cc/40?img=12", phone: "234-567-8901", address: "234 Elm St, Othertown, USA", plate: "HIJ456", make: "Ford", model: "Fusion", dents: [] },
  ...
  { id: "Wo-018", customer: "Rachel Green", email: "rachel@example.com", status: "follow-up_required", dateReceived: "31 August 2025", dateUpdated: "1 September 2025", customerAvatar: "https://i.pravatar.cc/40?img=18", phone: "890-123-4567", address: "890 Spruce St, Anyburg, USA", plate: "YZA567", make: "Subaru", model: "Outback", dents: [] },
...
const shops: Shop[] = [
  { id: "#001", name: "FixIt Shop", owner: "Dana White", status: "active", address: "123 Main St", postalCode: "T3J 4T3", contact: "555-123-1234", email: "fixit@example.com" },
  { id: "#002", name: "Bright Lights", owner: "Chris Evans", status: "inactive", address: "456 Elm St", postalCode: "A2L 3T4", contact: "555-567-5678", email: "brightlights@example.com" },
  { id: "#003", name: "Plumb Perfect", owner: "Alice Johnson", status: "active", address: "789 Oak St", postalCode: "L9M 1A1", contact: "555-9012-9012", email: "plumbperfect@example.com" },
  { id: "#004", name: "PaintPro", owner: "Bob Smith", status: "active", address: "321 Pine St", postalCode: "Q2Q 1A1", contact: "555-345-6234", email: "paintpro@example.com" },
  { id: "#005", name: "Carpentry Hub", owner: "Charlie Brown", status: "inactive", address: "654 Maple St", postalCode: "W1Y 4T3", contact: "555-789-0777", email: "carpentryhub@example.com" },
  { id: "#006", name: "AC Masters", owner: "Grace Lee", status: "active", address: "159 Birch St", postalCode: "Q1W 2X3", contact: "555-234-5345", email: "acmasters@example.com" },
  { id: "#007", name: "RoofFix", owner: "Hank Miller", status: "inactive", address: "753 Cedar St", postalCode: "G5Q 1A1", contact: "555-678-6789", email: "roofFix@example.com" },
  { id: "#008", name: "GardenWorks", owner: "Ivy Wilson", status: "active", address: "852 Willow St", postalCode: "A6S 4T3", contact: "555-345-9086", email: "gardenworks@example.com" },
  { id: "#009", name: "Window World", owner: "Jack Taylor", status: "active", address: "963 Spruce St", postalCode: "A2Q 1A1", contact: "555-901-0982", email: "windowworld@example.com" },
  { id: "#010", name: "ElectroFix", owner: "Eve Adams", status: "inactive", address: "741 Birch St", postalCode: "12345", contact: "555-234-7654", email: "electrofix@example.com" },
  { id: "#011", name: "SteelWorks", owner: "Karen Thomas", status: "active", address: "258 Cedar St", postalCode: "67890", contact: "555-678-6789", email: "steelworks@example.com" },
  { id: "#012", name: "Power Plumbing", owner: "Liam Scott", status: "inactive", address: "369 Elm St", postalCode: "98765", contact: "555-789-4560", email: "powerplumbing@example.com" },
  { id: "#013", name: "ColorPro Paints", owner: "Mia Harris", status: "active", address: "123 Main St", postalCode: "12345", contact: "555-123-9084", email: "colorpro@example.com" },
  { id: "#014", name: "QuickFix Garage", owner: "Noah Brooks", status: "inactive", address: "456 Elm St", postalCode: "67890", contact: "555-567-0988", email: "quickfix@example.com" },
  { id: "#015", name: "Vision Glass", owner: "Olivia Davis", status: "active", address: "789 Oak St", postalCode: "13579", contact: "555-901-3452", email: "visionglass@example.com" },
  { id: "#016", name: "BuildRight", owner: "Paul Wright", status: "inactive", address: "321 Pine St", postalCode: "24680", contact: "555-345-8906", email: "buildright@example.com" },
  { id: "#017", name: "Pro Roofing", owner: "Quinn Foster", status: "active", address: "654 Maple St", postalCode: "98765", contact: "555-789-9870", email: "proroofing@example.com" },
  { id: "#018", name: "GreenScape", owner: "Rachel Green", status: "inactive", address: "852 Willow St", postalCode: "24680", contact: "555-345-9086", email: "greenscape@example.com" },
  { id: "#019", name: "Elite Auto", owner: "Sam Parker", status: "active", address: "963 Spruce St", postalCode: "13579", contact: "555-901-9872", email: "eliteauto@example.com" },
